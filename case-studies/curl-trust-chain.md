...
- **更新 (2026-06-02)**: curl 赏金计划已正式终止。Discussion 21846 中团队确认不再支付任何赏金。历史上显示的金额是过去支付记录。这意味着 P1 发现的缺口已在现行政策中闭合——政策与实际状态现在一致。这一变化本身也是"比例变化脆弱性"的压力反应：AI slop 导致的审查成本上升触发了赏金取消决策。
